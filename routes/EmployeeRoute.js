...
const { getOnboardingStatus, getUserProfile, postUserProfile, getAllEmployees, approveApplication, rejectApplication } = require('../controllers/onboardingController');
